...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1991522624 1197918807 -1002049269766').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001954637243 -1001519696446 -1001736667926 -1001954637243 -1002049269766').split()]
...
VERIFY2_API = environ.get('VERIFY2_API', "2201156ef76f39254d58f58c116e41b2f5f513f1")
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'adrinolinks.in')
SHORTLINK_API = environ.get('SHORTLINK_API', '2201156ef76f39254d58f58c116e41b2f5f513f1')
